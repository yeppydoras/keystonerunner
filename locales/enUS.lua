...
-- review mark
L["msgUsageDetail"] = "  /ksr p - Report to party\r  /ksr g - Report to guild\r  /ksr s - Report to \"say\"\r  /ksr w [name-realm] - Report to character(whisper)\r  /ksr w - Report to last player who sends you message\r  /ksr r - Report to last player who sends you message contains keywords (i.e. \"Keystone\")\r  /ksr log - View Mythic+ log\r  /ksr log <keyword1> <keyword2> ... - Search Mythic+ log with keyword(s)\r  /ksr opt mythicautoreply - Toggle feature: Mythic+ auto reply\r  /ksr opt keyautoreply - Toggle feature: Auto report keystones(#key)\r  /ksr wipelog - Clean Mythic+ log\r  /ksr clear - Clear all data"
