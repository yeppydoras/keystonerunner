...
-- review mark
L["msgUsageDetail"] = "  /ksr p - 報告到小隊頻道\r  /ksr g - 報告到公會頻道\r  /ksr s - 報告到say頻道\r  /ksr w [角色名字-伺服器] - 密語報告給特定角色\r  /ksr w - 密語報告給上一個發來消息的玩家\r  /ksr r - 報告給上一個發來的消息中包含特定關鍵詞（例如：鑰石）的玩家\r  /ksr log - 查看大秘境日誌\r  /ksr log <keyword1> <keyword2> ... - 以關鍵詞檢索大秘境日誌\r  /ksr wipelog - 清除大秘境日誌\r  /ksr clear - 清除所有數據"
