...
L["msgNotInGroup"] = "<Keystone Runner> 你現在不在隊伍中"
L["msgNotInGuild"] = "<Keystone Runner> 你現在沒有公會"
L["msgMPlusDND"] = "<Keystone Runner> %s 正在挑戰：%s(+%s)，擊殺首領：%s/%s，%s：%s，已耗時：%s。向我發送 %s 查看我的所有鑰石。<15分鐘之內不會再次自動回覆>"
